...
#ifndef ONOFFPACKETGENERATOR_H_
#define ONOFFPACKETGENERATOR_H_
...
class OnOffPacketGenerator : public PacketGenerator  {
public:
    OnOffPacketGenerator();
    virtual ~OnOffPacketGenerator();
